...
| **Screenshot to Code** | Convert UI screenshots into single-file HTML, React, or Vue code through Astron MaaS vision models. | [`iflytek-screenshot-to-code`](./skills/iflytek-screenshot-to-code) |
